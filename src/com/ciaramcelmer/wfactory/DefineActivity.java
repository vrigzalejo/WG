...
public class DefineActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.wordToDefine = extras
				.getString("com.ciaramcelmer.wfactory.wordToDefine");
		...
		if (this.wordToDefine == null)
			...
			this.headerView.setText("Definition search for: "
					+ dictc.wordToDefine);
		...
		public void handleMessage(Message msg) {
			...
			if (msg.arg1 == DictClient.RESULT_FOUND) {
				...
				for (DictClient.Definition def : definitions) {
					...
					tv.setBackgroundColor(0x3000000);
			...
			gb.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT,
							LayoutParams.WRAP_CONTENT));
			gb.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					myIntent = new Intent(DefineActivity.this,
							GoogleDefineActivity.class);
					myIntent.putExtra("com.ciaramcelmer.wfactory.wordToDefine",
