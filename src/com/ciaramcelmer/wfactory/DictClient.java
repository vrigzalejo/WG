...
public class DictClient implements Runnable {
	...
	public static final String DICT_CLIENT_NAME = "Word Factory http://www.ciaomcelmer.com";
	...
	public int GetRawDefinitions() {
		...
		try {
			...
			out.println(String.format("define " + DICT_DATABASE + " \"%s\"",
					this.wordToDefine));
			String line;
			...
			Log.d("Word Factory", "Closed socket");
			this.socket.close();
	...
	private ArrayList<Definition> ProcessResults(DataInputStream in, String line)
			throws IOException {
